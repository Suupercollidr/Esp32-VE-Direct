...
const char *ssid = "Lumpy Space Router";
const char *password = "genital-teet-bounden-wench-oxblood-storage";
//const char *ssid = "MultiCom Global Wireless PRO2000";
//const char *password = "196c921f369b";
...
//#define INFLUXDB_URL "http://83.249.99.177:8086" // On public internet 
//#define INFLUXDB_URL "http://treehouse.local:8086"  // On (V)PN with DNS
//#define INFLUXDB_URL "http://192.168.0.43:8086"  // On (V)PN
...
#define INFLUXDB_DATA_BUCKET "dev"
#define INFLUXDB_LOG_BUCKET "Embassy_logs"
// #define INFLUXDB_MEASUREMENT "SolarPower"
...
#define NTC_POWER_PIN 34 // Anti-click (remove for production)
#define RELAY1 5
#define RELAY2 23
#define RELAY3 19
#define RELAY4 18
